...
Vignette: [Using the package skeleton for patient-level prediction studies](https://raw.githubusercontent.com/OHDSI/StudyProtocolSandbox/master/PredictionForDLBCL/inst/doc/UsingSkeletonPackage.pdf)
...
```r
  library(PredictionForDLBCL)
  # USER INPUTS
#=======================
# The folder where the study intermediate and result files will be written:
outputFolder <- "./PredictionForDLBCLResults"
...
cohortTable <- 'PredictionForDLBCLCohort'
#=======================
...
```r
  ...
  devtools::install_github("OHDSI/StudyProtocolSandbox/PredictionForDLBCL")
```
