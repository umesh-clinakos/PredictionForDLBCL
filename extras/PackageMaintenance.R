...
OhdsiRTools::checkUsagePackage("PredictionForDLBCL")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/PredictionForDLBCL.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PredictionForDLBCL.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "PredictionForDLBCL")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("PredictionForDLBCL")
